...
- (void)previewController:(RPPreviewViewController *)previewController didFinishWithActivityTypes:(NSSet <NSString *> *)activityTypes
{
    if ([activityTypes containsObject:@"com.apple.UIKit.activity.SaveToCameraRoll"]) {
        ...
        UIAlertView *view = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"FinishRecord", comment: @"访问限制说明") message:nil delegate:self cancelButtonTitle:NSLocalizedString(@"IKnow", comment: @"我知道了") otherButtonTitles:nil];
        [view show];
...
-(UIViewController *)getRootVC{
    MainViewController *vc = [UIApplication sharedApplication].delegate.window.rootViewController;
    return vc.solarView;
}
